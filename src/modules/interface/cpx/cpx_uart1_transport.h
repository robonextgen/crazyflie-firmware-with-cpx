...
/**
 * @brief Initialize the UART1 transport
 * 
 * This will also initialize the UART1 peripheral.
 * 
 */
void cpxUART1TransportInit(void);

/**
 * @brief De-initialize the UART1 transport
 * 
 * This is used to gracefully shut down the UART1 transport so
...
/**
 * @brief Send a CPX packet via the UART1 transport
 * 
...
/**
 * @brief Receive a CPX packet via the UART1 transport
 * 
